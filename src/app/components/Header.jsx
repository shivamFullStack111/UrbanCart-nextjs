  ...
  return (
    <>
      <div className="">
        <div
          className={
            "flex items-center   justify-between max-800px:hidden  border-b-[1px] border-gray-300 w-[100vw] py-2 h-20"
          }
        >
        ...
        <div className="flex max-800px:hidden h-14  w-[100vw]   items-center justify-between px-[7vw] py-4 bg-black">
      ...
      <div className=" w-full items-center bg-teal-500 text-white p-3 flex shadow-md justify-between   800px:hidden">
